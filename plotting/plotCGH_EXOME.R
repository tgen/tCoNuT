#plotCGH_EXOME <- function(cghTSV,gainedTSV,lossedTSV,pngName){
#
#  plotCGH_EXOME is an R function for plotting exome copy number from tCoNuT.
#  Individual chromosomes are plotted in a figure with 6 x 4 layout.
#
#  Rscript --vanilla plotCGH_EXOME.R SAMPLE.cna.tsv SAMPLE.amp.tsv SAMPLE.del.tsv SAMPLE.cna
#
#  ARGUMENTS:
