...
<b>Step 4:</b> Run tCoNuT with DAT and merged.vcf.txt files. You will need a TARGETSFILE if running as exome.  You can find these at http://tools.tgen.org/BED/tCoNuT_BEDfiles/ for some Agilent kits. This example is showing parameters for exome data.
