#runDNAcopyV2 Rscript
#
#  runDNAcopyV2 runs the CBS algorithm implemented in DNAcopy 
#  on tCoNuT whole genome copy number data. DNAcopy parameters 
#  were optimized for in-house whole genome data. User may need to modify for their 
#  data needs. Requires the DNAcopy from Bioconductor. 
#  https://bioconductor.org/packages/release/bioc/html/DNAcopy.html
#
#  Rscript --vanilla runDNAcopyV2.R SAMPLE.cna.tsv SAMPLE.seg
#
#  INPUTS:
...
segment.CNA.object=segment(CNA.object,alpha=0.001,verbose=1,undo.splits="sdundo",undo.SD=15,min.width=5)
